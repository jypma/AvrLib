...
public:
    static constexpr count_t zero_length  = (400_us).toCountsOn<comparator_t>().getValue();
    static constexpr count_t one_length  = (600_us).toCountsOn<comparator_t>().getValue();
